...
M.colors = {
    ...
    bright_red = "#ff8b61",
    bright_green = "#6a8d8b",
    bright_yellow = "#ffb284",
    bright_blue = "#8ca6a9",
    bright_magenta = "#c59f92",
    bright_cyan = "#93b9b8",
    bright_white = "#e0d8d0",
	...
	-- Strings
	string = "#536c6e",
	string_template = "#6a8d8b",
	string_escape = "#6a8d8b",
	string_regex = "#6a8d8b",
	...
	-- Terminal colors
	terminal_black = "#2c3a3a",
	terminal_red = "#f47a4d",
	terminal_green = "#536c6e",
	terminal_yellow = "#e39a7a",
	terminal_blue = "#6a8285",
	terminal_magenta = "#a9867a",
	terminal_cyan = "#7aa09f",
	terminal_white = "#c7beb6",
	terminal_bright_black = "#4d6161",
	terminal_bright_red = "#ff8b61",
	terminal_bright_green = "#6a8d8b",
	terminal_bright_yellow = "#ffb284",
	terminal_bright_blue = "#8ca6a9",
	terminal_bright_magenta = "#c59f92",
	terminal_bright_cyan = "#93b9b8",
	terminal_bright_white = "#e0d8d0",
